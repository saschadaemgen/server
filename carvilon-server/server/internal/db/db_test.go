...
func TestOpen_AppliesMigrations(t *testing.T) {
	...
	if version != 41 {
		t.Errorf("schema_version = %d, want 41", version)
	}
	for _, table := range []string{
		...
		"viewer_doors",
		"license", "license_features", "templates", "template_features",
		"viewer_feature_exposure",
		"telegram_allowed_chats", "telegram_pending_chats",
		"designer_folders", "designer_graphs",
		"console_profiles", "console_host_keys",
		"carvilon_users",
		"readers",
		"shelly_devices",
		"sensor_samples", "sensor_recording",
	} {
		var name string
		err := d.QueryRow(
