...
// lucideIcons holds the subset of Lucide-style SVG icons used by
// the admin UI. Sourced from lucide.dev and embedded as
// string constants so the binary does not need a filesystem
// at runtime.
//
// All icons share the same 24x24 viewBox, stroke-currentColor,
// stroke-width 2, no fill. They inherit color from the
// surrounding text via `currentColor`. Size in the template via
// Tailwind classes such as w-4 h-4 or w-5 h-5.
var lucideIcons = map[string]string{
	...
	"phone-off": `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10.68 13.31a16 16 0 0 0 3.41 2.6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7 2 2 0 0 1 1.72 2v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.42 19.42 0 0 1-3.33-2.67"/><path d="M5.17 5.17A19.79 19.79 0 0 1 2.12 2.18 2 2 0 0 1 4.11 0h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 7.91"/><line x1="22" x2="2" y1="2" y2="22"/></svg>`,
...
// renderIcon returns the SVG markup for the named icon. Missing
// icons return empty so a template typo does not crash the
// render path.
