...
// viewers table.
//
// Admin sessions used to live in the shared sessions table with
// the ua_user_id surrogate "_admin_<username>". Since viewer
// sessions are now hard-FK'd to the viewers table (renamed from
// mock_viewers by Migration 006), admin sessions live in their
// own admin_sessions table (created in Migration 003, FK kept on
// admin_users).
//
